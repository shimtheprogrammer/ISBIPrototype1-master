...
public class AddPreSalesActivity extends Activity {
    public static String TAG = "AddPreSalesActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_pre_sale);
        ...
        product.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               // double cst = (inventory.getSPrice());
                ...
                for (Inventory pd : inventoryList) {
                    if (pd.getProduct().matches("" + item)) {
                        ...
                        cost.setText("" + numberFormat.format(Math.round(pd.getSPrice())));
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (product.getText().toString().matches("")) {
                    ...
                    gpsdb.addGoodsPreOrdered(new GoodsPreOrdered(product.getText().toString(),
                            (int) Math.round(numb), units, cst, (int) Math.round(numb * cst),
                            date , psdb.getRowCount() + 1));
                    ...
                    if(sales.size() == 1 && !(getIntent().getStringExtra("FROM").matches("REG"))){
    ...
    /**
     * setting for unit spinner
     **/

    public void setUnitSpinner(List<String> list) {
        ArrayAdapter<String> dataAdapterUnits = new ArrayAdapter<String>(this, R.layout.activity_spinner_item, list);
