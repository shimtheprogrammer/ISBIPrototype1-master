...
public class AddPurchaseActivity extends Activity {
    public static String TAG = "AddPurchaseActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        product.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Inventory inventory = idb.getInventoryByProduct(item);
                double cst = (inventory.getCost());

                if(inventory != null){
                    if(inventory.getUnit().matches("Pcs")){
                        Log.d(TAG, "onItemSelected; found unit " + inventory.getUnit());
                        List<String> unitTypes = new ArrayList<>();
                        unitTypes.add("Pcs");
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (product.getText().toString().matches("")) {
                    ...
                    gpdb.addPurchases(new GoodsPurchased(product.getText().toString(),
                            (int) Math.round(numb), units, cst, (int) Math.round(numb * cst),
                            date , pdb.getRowCount() + 1));
