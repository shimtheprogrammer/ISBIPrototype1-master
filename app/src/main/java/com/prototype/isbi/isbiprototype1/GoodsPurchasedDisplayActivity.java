...
public class GoodsPurchasedDisplayActivity extends AppCompatActivity
    ...
    private void prepareListData() {
        ...
        listDataHeader.add("Goods Purchased: " + count);
