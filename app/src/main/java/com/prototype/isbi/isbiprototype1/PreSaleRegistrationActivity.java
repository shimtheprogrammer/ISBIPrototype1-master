...
public class PreSaleRegistrationActivity extends Activity {
    public static String TAG = "PreSaleRegstrtnActivity";
    ...
    private void prepareListData() {
        ...
        listDataHeader.add("Pre Sales Orders: " + count + "-" + title);
        Log.d(TAG, "hesder ; " + "Pre-Sales Orders: " + count + "-" + title);
