...
public class SoldAssetsDisplayActivity extends AppCompatActivity
    ...
    SoldAssetsHandler edb = new SoldAssetsHandler(this);
    ...
    private void prepareListData() {
        ...
        for (SoldAssets pd : allAssets) {
            ...
            String log = "Id: " + pd.getID() + " \t\tType: " + pd.getType() + "\t\tInfo: " + pd.getInfo()
                    + "\t\tTotal: " + numberFormat.format(pd.getTotal()) + "\t\tPayment Method: " + pd.getPayment()
                    + "\t\tDate: " + pd.getDate() + "\t\tUsefull Life: " + useful + "\t\tScrap Value: " + scrap
                    + "\t\tSale Value: " + pd.getSale()  + "\t\tSale Date: " + pd.getSaleDate()
                    + "\t\tForeign Key: " + pd.gettForeignKey();
            Log.d("Insert: ", log);
            assets.add(log);
            count++;
        }

        listDataHeader.add("Sold Assets: " + count);
