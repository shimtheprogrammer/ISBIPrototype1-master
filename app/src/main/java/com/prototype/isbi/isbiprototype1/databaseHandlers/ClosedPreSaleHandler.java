...
public class ClosedPreSaleHandler extends SQLiteOpenHelper {
    ...
    //table name
    public static String TABLE_NAME = "ClosedPreSale";
    ...
    public ClosedPreSaleHandler(Context context){
    ...
    public void onCreate(SQLiteDatabase db){
        TABLE_NAME = "ClosedPreSale" + LoginActivity.database;
        //create table
    ...
    //add new entry
    public void addPreSale(ClosedPreSale sales){
        TABLE_NAME = "ClosedPreSale" + LoginActivity.database;
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        values.put(KEY_FOREIGN_KEY, sales.getForeignKey());
    ...
    public ClosedPreSale getPreSale(int id){
        TABLE_NAME = "ClosedPreSale" + LoginActivity.database;
        SQLiteDatabase db = this.getReadableDatabase();

        ClosedPreSale sale = new ClosedPreSale();
        ...
        if(cursor != null) {
            ...
            sale = new ClosedPreSale(Integer.parseInt(cursor.getString(0)), cursor.getString(1), Integer.parseInt(cursor.getString(2)),
    ...
    //get all entries
    public List<ClosedPreSale> getAllPreSale() {
        TABLE_NAME = "ClosedPreSale" + LoginActivity.database;
        List<ClosedPreSale> salesList = new ArrayList<>();
        ...
        if(cursor.moveToFirst()){
            do{
                ClosedPreSale sales = new ClosedPreSale();
                ...
                sales.setForeignKey(Integer.parseInt(cursor.getString(6)));
    ...
    public int updatePreSale(ClosedPreSale sales){
        TABLE_NAME = "ClosedPreSale" + LoginActivity.database;
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    //delete single entry
    public void deletePreSale(ClosedPreSale sales){
        TABLE_NAME = "ClosedPreSale" + LoginActivity.database;
        SQLiteDatabase db = this.getWritableDatabase();
