...
public class GoodsPreOrderedHandler extends SQLiteOpenHelper {

    private static final String TAG = "Goods pre ordered DB Handler:";
    ...
    //table name
    public static String TABLE_NAME = "GoodsPreOrdered";
    ...
    public GoodsPreOrderedHandler(Context context){
    ...
    public void onCreate(SQLiteDatabase db){
        TABLE_NAME = "GoodsPreOrdered" + LoginActivity.database;
        //create table
    ...
    //get all entries
    public List<GoodsPreOrdered> getAllGoodsPreOrders() {
        TABLE_NAME = "GoodsPreOrdered" + LoginActivity.database;
