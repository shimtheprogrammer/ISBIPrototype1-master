...
public class GoodsPurchased {
    ...
    public GoodsPurchased() {

    }

    //constructor
    public GoodsPurchased(int id, String product, int number, String unit, double cost, int total, String date, int foreignKey){
        this._id = id;
    ...
    //constructor
    public GoodsPurchased(String product, int number, String unit, double cost, int total, String date, int foreignKey){
        this._product = product;
        this._number = number;
        this._unit = unit;
        this._cost = cost;
