...
public class GoodsSales {
    ...
    //constructor
    public GoodsSales(int id, String product, int number, String unit, double cost, int total, String date, int foreignKey, double pcost){
        this._id = id;
    ...
    //constructor
    public GoodsSales(String product, int number, String unit, double cost, int total, String date, int foreignKey, double pcost){
        this._product = product;
        this._number = number;
        this._unit = unit;
        this._cost = cost;
    ...
    //getting cost
    public double getPCost() { return this._pcost; }

    //setting cost
    public void setPCost(double pcost) { this._pcost = pcost; }
}
