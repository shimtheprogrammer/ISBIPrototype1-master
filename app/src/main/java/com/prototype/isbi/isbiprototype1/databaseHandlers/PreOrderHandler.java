...
public class PreOrderHandler extends SQLiteOpenHelper {
    ...
    //table name
    public static String TABLE_NAME = "PreOrder";
    ...
    public PreOrderHandler(Context context){
    ...
    public void onCreate(SQLiteDatabase db){
        TABLE_NAME = "PreOrder" + LoginActivity.database;
        //create table
    ...
    //add new entry
    public void addPreOrder(PreOrder purchase){
        TABLE_NAME = "PreOrder" + LoginActivity.database;
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        values.put(KEY_STATUS, purchase.getStatus());
    ...
    public PreOrder getPreOrder(int id){
        ...
        PreOrder purchase = new PreOrder();
        ...
        if(cursor != null) {
            ...
            purchase = new PreOrder(Integer.parseInt(cursor.getString(0)),
    ...
    public List<PreOrder> getAllPreOrder() {
        TABLE_NAME = "PreOrder" + LoginActivity.database;
        List<PreOrder> purchaseList = new ArrayList<>();
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                purchase.setStatus(cursor.getString(6));
    ...
    public int updatePreOrder(PreOrder purchase){
        TABLE_NAME = "PreOrder" + LoginActivity.database;
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    //delete single entry
    public void deletePreOrder(PreOrder purchase){
        TABLE_NAME = "PreOrder" + LoginActivity.database;
        SQLiteDatabase db = this.getWritableDatabase();
