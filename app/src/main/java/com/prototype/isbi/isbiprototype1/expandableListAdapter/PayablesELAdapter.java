...
import com.prototype.isbi.isbiprototype1.PayablesActivity;
...
public class PayablesELAdapter extends BaseExpandableListAdapter implements TextWatcher{
        ...
        public PayablesELAdapter(Context context, List<String> listDataHeader,
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            Add.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //((PayablesActivity) _context).finish();
                }
            });
