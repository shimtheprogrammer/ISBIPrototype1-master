...
import com.prototype.isbi.isbiprototype1.PurchaseActivity;
...
public class PurchaseELAdapter extends BaseExpandableListAdapter implements TextWatcher {
    ...
    //defince
    public PurchaseELAdapter(Context contex, List<String> listDataHeader, HashMap<String, List<String>> listChildData, String where) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(_where.matches("pre")){
                    Intent intent = new Intent (_context, AddPreOrderActivity.class);
                    _context.startActivity(intent);
//                    ((PreOrderActivity) _context).finish();
                } else {
                    Intent intent = new Intent(_context, AddPurchaseActivity.class);
                    _context.startActivity(intent);
//                    ((PurchaseActivity) _context).finish();
                }
            }
        });
